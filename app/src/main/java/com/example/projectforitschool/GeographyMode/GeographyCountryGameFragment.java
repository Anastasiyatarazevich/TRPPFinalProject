...
public class GeographyCountryGameFragment extends Fragment {

    Button buttonFirst, buttonSecond, buttonThird, buttonFourth;
    TextView textViewTimeLeft , textViewQuestionsLeft;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_geography_country_game, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        game = new GameGeographyMode(GameGeographyMode.Mode.COUNTRY , hostActivity.gameSize , hostActivity.gameQuestions , hostActivity.countries);
        ...
        View.OnClickListener answerButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!correct)
                {
                    ...
                    {
                        if (buttonClicked.getText().equals(answers[x].getName()))
                        {
    ...
    private void nextTurn()
    {
        ...
        buttonFirst.setText(answers[0].getName());
        buttonSecond.setText(answers[1].getName());
        buttonThird.setText(answers[2].getName());
        buttonFourth.setText(answers[3].getName());
        ...
        timer = new CountDownTimer(secondsRemaining * 1000 , 1000) {
            ...
            public void onTick(long l) {
                textViewTimeLeft.setText(secondsRemaining + " sec");
    ...
    private void endGame()
    {
        ...
        GeographyGameStatUnit gameUnit = new GeographyGameStatUnit(rightNow.get(Calendar.DATE), rightNow.get(Calendar.MONTH) + 1, rightNow.get(Calendar.YEAR), game.getNumberCorrect() , gameDuration , "Countries" , gameResult , game.getGameSize());
